                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive" id="grade-table">
                                        <table class="table table-sm table-hover">
                                            ...
                                            @include('layouts.employee.loan._proposed_loan_list')
                                            </tbody>
                                        </table>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <form class="form-sample" method="post" action="{{route('save.employee.loan.application')}}">
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive" id="grade-table">
                                        <table class="table table-sm table-hover">
                                            ...
                                            <tbody id="proposed-loan-list">
                                            @include('layouts.employee.loan._application_loan_list')
                                            </tbody>
                                        </table>
                                        <div class="col-sm-12 position">
