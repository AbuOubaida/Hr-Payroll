                    ...
                    <div class="col-sm-7">
                        <div class="form-group form-group-sm">
                            <div class="input-group input-group-sm">
                                ...
                                <input id="emp" type="text" class="form-control form-control-sm" placeholder="Search by Employee ID or Email" aria-label="Username" aria-describedby="basic-addon1" onkeyup="return searchAttendance(this)">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control text-white" id="year" name="order" onchange="return searchAttendance(this)">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control text-white" id="month" name="order" onchange="return searchAttendance(this)">
                                    <option value="">All</option>
                                    @if($month)
                                        @foreach($month as $m)
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control text-white" id="date" name="order" onchange="return searchAttendance(this)">
                                    <option value="">All</option>
                                    @if($date)
                                        @foreach($date as $d)
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control text-white" id="dep" name="order" onchange="return searchAttendance(this)">
                                    <option value="">All</option>
                                    @if($department)
