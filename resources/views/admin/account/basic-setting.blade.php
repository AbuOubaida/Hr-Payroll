                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class=" text-center">
                                <a href="{{url('admin/employee/edit/'.\Illuminate\Support\Facades\Auth::user()->id)}}" class=""><button type="button" class="btn btn-outline-primary btn-icon-text"> Edit Profile<i class="mdi mdi-file-check btn-icon-append"></i></button></a>

                                <a href="{{url('admin/employee/view/'.\Illuminate\Support\Facades\Auth::user()->id)}}" class="btn btn-outline-warning">View Profile
                                    <i class="mdi mdi-eye btn-icon-append"></i>
                                </a>
                            </div>
