    ...
    @foreach($loans as $loan)
        <tr class="@if($loan->proposed_loan_id == \Illuminate\Support\Facades\Request::route('pId')){{'text-white'}}@endif">
            ...
            <td class="text-center">
                ...
                <a href="{{url('employee/loan/view-proposed-loan-project/'.$loan->proposed_loan_id)}}" class="text-warning" title="Full view of Loan Proposed Loan"> <i class="mdi mdi-eye"></i></a>
            </td>
        </tr>
    @endforeach
@else
