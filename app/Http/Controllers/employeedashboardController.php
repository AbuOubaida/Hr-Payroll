...
class employeedashboardController extends Controller
{
    ...
    public function showAttendance()
    {
        ...
        return view('employee/attendance/attendance-list',compact('attendance','year','month','date','department'));
    }
    ...
    public function singleViewAtt($id)
    {
        ...
        return view('employee/attendance/single-view',compact('data','first','late'));
    }
    ...
    public function salaryList()
    {
        ...
        $salary = salary::leftJoin('users as u','u.id','salaries.emp_id')
            ...
            ->paginate($this->record);
        return view('employee/payroll/salary-list',compact('year','month','department','protocol','salary'));
    }
    ...
    public function accountSetting()
    {
        ...
        return view('employee/account/basic-setting',compact('company','user'));
    }
    //search All List
    ...
    public function singleSalaryView($id)
    {
        ...
        return view("employee/payroll/single-view",compact('salary','pf','pt','runningLoan','companyProtocol'));
    }
}
