...
class loanProjectManagerController extends Controller
{
    private $html = null;
    private $record = 10;
    ...
    public function index()
    {
        ...
        $loanApplications = loan_application_list::leftJoin('proposed_loans as pl','pl.proposed_loan_id','loan_application_lists.loan_appl_proposed_id')
            ...
            ->paginate($this->record);
//        dd($loanApplications);
        return view('project-manager/loan/create-loan',compact('loans','loanApplications'));
    }
     ...
     *
     * @param  \App\Models\loan_application_list  $loan_application_lists
     * @return Response
     */
    public function show(loan_application_list $loan_application_lists)
    {
        //
    }
     ...
     * @return Response
     */
    public function edit(loan_application_list $loan_application_lists)
    {
        //
    }
     ...
     * @return Response
     */
    public function update(Request $request, loan_application_list $loan_application_lists)
    {
        //
    }
     ...
     * @return Response
     */
    public function destroy(loan_application_list $loan_application_lists)
    {
        //
    }
    //view proposed loan
    public function viewProposedLoan($id)
    {
        try {
            ...
            $loans = proposed_loan::leftJoin('loan_types as lnt','lnt.loan_type_id','proposed_loans.proposed_loan_type_id')
                ...
                ->orderBy('proposed_loans.proposed_loan_id','desc')
                ->paginate($this->record);
            return view('project-manager/loan/view-proposed-loan',compact('proposedLoan','loans'));
        }catch (Throwable $exception)
        {
            return back()->with('error',$exception->getMessage());
        }
    ...
    public function viewApplicationLoan($id)
    {
        try {
            ...
            {
                return redirect('project-manager/loan/loan-application');
            }
//        dd($loanApplication);
            return view('project-manager/loan/view-application-loan',compact('loanApplication','loanApplications','installments'));
        }catch (Throwable $exception)
        {
            return redirect('project-manager/loan/loan-application')->with('error',$exception->getMessage());
        }
